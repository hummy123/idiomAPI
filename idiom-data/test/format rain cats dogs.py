...
sentences = get_data("test dataset.ods", start_column=0, column_limit=1)
senList = list(chain.from_iterable(sentences['Sheet1']))

category = get_data("test dataset.ods", start_column=1, column_limit=1)
...
semSentences = get_data("test dataset.ods", start_column=0, column_limit=1)